...
bin/md5_test: unitest/CMakeFiles/md5_test.dir/link.txt
	...
	cd /root/miniob/build/unitest && /usr/local/bin/cmake/bin/cmake -D TEST_TARGET=md5_test -D TEST_EXECUTABLE=/root/miniob/build/bin/md5_test -D TEST_EXECUTOR= -D TEST_WORKING_DIR=/root/miniob/build/unitest -D TEST_EXTRA_ARGS= -D TEST_PROPERTIES= -D TEST_PREFIX= -D TEST_SUFFIX= -D NO_PRETTY_TYPES=FALSE -D NO_PRETTY_VALUES=FALSE -D TEST_LIST=md5_test_TESTS -D CTEST_FILE=/root/miniob/build/unitest/md5_test[1]_tests.cmake -D TEST_DISCOVERY_TIMEOUT=5 -D TEST_XML_OUTPUT_DIR= -P /usr/local/bin/cmake/share/cmake-3.20/Modules/GoogleTestAddTests.cmake
